    ...
    def recommend_next_observation(
        ...
        for sensor, spec in self.sensor_specs.items():
            ...
            explanation = (
                ...
                f"POTENTIALLY_REDUCES_UNCERTAINTY: May reduce {target_q} epistemic uncertainty by up to {unc_reduction*100:.1f}%."
        ...
        is_synth = bool(entity.is_synthetic)
        ...
        if existing:
            ...
            existing.is_synthetic = is_synth
            rec = existing
        else:
